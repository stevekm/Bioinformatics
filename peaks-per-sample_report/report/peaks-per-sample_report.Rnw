...
Project_ID<-latexTranslate("SmithLab-ChIPSeq_2016-06-06 Peaks per Sample per Peak Calling setting") # for the title slide
Report_author<-latexTranslate("Stephen Kelly")
PI_name<-latexTranslate("Dr. Smith")
Report_author_email<-latexTranslate("email@internet.org")
...
# hardlink to the pipeline script:
...
\institute{ PI: \Sexpr{PI_name} \\ Genome Technology Center, \\ NYU Langone Medical Center, New York, NY 10016} % I might have broke this watch out :(
