...
def main(**kwargs):
    ...
    singlequote = kwargs.pop('singlequote', False)
    doublequote = kwargs.pop('doublequote', False)
...
def parse():
    ...
    parser.add_argument("--singlequote", action='store_true', dest = 'singlequote', help="Wrap the new column in single quotes")
    parser.add_argument("--doublequote", action='store_true', dest = 'doublequote', help="Wrap the new column in double quotes")
