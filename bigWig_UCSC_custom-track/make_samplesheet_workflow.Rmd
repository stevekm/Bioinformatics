...
# sample output: 
# track type=bigWig name=ABC-S-H3K27AC bigDataUrl=https://myserver.edu/results/SmithLab/alignment/bigwigs/AGK-D-H3K27AC.bw visibility=full autoScale=off alwaysZero=on maxHeightPixels=100 graphType=bar viewLimits=0:0.3 
